...
/**
 * Image servlet for serving branding resources from home directory.
 * 
 * @author BalusC
...
public class BrandingServlet extends HttpServlet {
	...
	public void init() throws ServletException {
		...
		// servlet.
		this.resourcePath = System.getProperty("user.home")
				+ "/.sivaServer/branding/";
	}
	...
	protected void doGet(HttpServletRequest request,
		...
		File resource = new File(resourcePath, URLDecoder.decode(requestedResource,
				"UTF-8"));
		...
		try{
			input = new BufferedInputStream(new FileInputStream(resource),
					DEFAULT_BUFFER_SIZE);
