...
public abstract class IAbstractBean implements Serializable {
	...
	/**
	 * Mehrsprachige Beschreibung des Objekts. Die Map speichert dabei die
	 * Beschreibung als Werte der Map und das jeweils zugehoerige Locale dient
	 * als Key.
	 */
...
////	public abstract List<IAbstractBean> getDependentObjects();
	...
	public String toString() {
		return this.getClass().getSimpleName() + "[" + getTitle() + "]"; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	/**
	 * Gibt die Keywords, die diesem Objekt zugeordnet sind, als
	 * komma-separierte Liste zurueck. Kommata selbst werden dabei durch
	 * Backslashes escaped, z.B. der Wert "Einstein\, Albert,
	 * Physiker" ergibt zwei Keywords: "Einstein, Albert" und "Physiker".
	 * 
	 * @return Liste der Keywords in komma-separierter Form.
	 * @uml.property name="keywords"
	 */
	...
	/**
	 * Setzt die Keywords, die diesem Objekt zugeordnet sind, in Form einer
	 * komma-separierten Liste. Kommata selbst werden dabei durch Backslashes
	 * escaped, z.B. der Wert "Einstein\, Albert,
	 * Physiker" ergibt zwei Keywords: "Einstein, Albert" und "Physiker".<br>
	 * <br>
	 * Ein Aufruf dieser Methode resultiert in einem PropertyChangeEvent fuer
	 * das Property <tt>PROP_KEYWORDS</tt> mit altem und neuem Wert des
	 * Properties.
	 * 
	 * @param keywords
	 *            Die neuen Keywords des Objekts in komma-separierter Form.
	 * @uml.property name="keywords"
	 */
	...
	public void setTitle(String title) {
		...
		LocalizedString newTitle = new LocalizedString(title, curLang);
		LocalizedString oldValue = titleMap.put(curLang, newTitle);
		firePropertyChange(PROP_TITLE, oldValue, newTitle);
	}
	...
	public void setDescription(LocalizedString description) {
		LocalizedString oldValue = descrMap.put(description.getLanguage(),
				description);
	...
	public void setDescription(String description) {
		Locale curLang = project.getCurrentLanguage();
		LocalizedString newValue = new LocalizedString(description, curLang);
		LocalizedString oldValue = descrMap.put(curLang, newValue);
		firePropertyChange(PROP_DESCRIPTION, oldValue, newValue);
	}

	/**
	 * Gibt das zugehoerige Projekt zurueck. Diese Methode ist nur zur internen
