 ...
 * @author juhoffma
 */
public abstract class AbstractMediaPlayer extends SivaEventProvider implements MediaPlayer {
		
	// Zeitsprünge bei den Vor/Zurück-Buttons
	private final long SEEKSTEP = 1000000000L;
	 ...
	 * @param mediaObject
	 */
	public AbstractMediaPlayer(IMediaObject mediaObject) {
	...
	public AbstractMediaPlayer(IMediaObject mediaObject, long startTime, long endTime) {
		this.media = mediaObject;
