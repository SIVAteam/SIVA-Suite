...
public class Messages extends NLS {
	...
	public static String BeanNameGenerator_GalleryFilePostfix;
	...
	public static String BeanNameGenerator_RichtextFilePostfix;

	public static String BeanNameGenerator_UnknownAnnotationTitle;
