...
import org.eclipse.mylyn.htmltext.commands.indent.IndentCommand;
import org.eclipse.swt.graphics.Image;

/**
 * @author Tom Seidel <tom.seidel@remus-software.org>
 */
public class IndentAction extends AbstractCommandWrapper {

	public IndentAction(HtmlComposer composer) {
		super("Indent", IAction.AS_PUSH_BUTTON, composer); //$NON-NLS-1
		setImageDescriptor(ImageDescriptor.createFromImage((Image)images.get(ActionImages.ActionImage_IndentAction)));
	}
