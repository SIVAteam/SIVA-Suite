...
import org.eclipse.mylyn.htmltext.commands.basicstyle.SubscriptCommand;
import org.eclipse.swt.graphics.Image;
/**
 * @author Tom Seidel <tom.seidel@remus-software.org>
 */
public class SubscriptAction extends AbstractCommandWrapper {

	public SubscriptAction(HtmlComposer composer) {
		super("Substrict", IAction.AS_CHECK_BOX, composer); //$NON-NLS-1$
		setImageDescriptor(ImageDescriptor.createFromImage((Image)images.get(ActionImages.ActionImage_SubscriptAction)));
	}

	@Override
	protected Command getWrappedCommand() {
		return new SubscriptCommand();
	}
}
