...
public class Messages extends NLS {
	...
	public static String ProjectChoosePlayerDesignPage_PlayerDesignDescription;

	public static String ProjectChoosePlayerDesignPage_PlayerDesignTitle;
	...
	public static String ProjectSetLayoutPage_LayoutDescription;

	public static String ProjectSetLayoutPage_LayoutTitle;

	public static String ProjectSetStartmodePage_StartmodeDescription;

	public static String ProjectSetStartmodePage_StartmodeTitle;
